...
Find S&P 500 stocks priced at or below $75 that are good candidates for a
...
Outputs:
    live/tqqq_sp500_prices.csv
    live/tqqq_sp500_volumes.csv
    live/tqqq_sp500_comovers.csv
...
OUT_CSV = LIVE_DIR / "tqqq_sp500_comovers.csv"
PRICES_CSV = LIVE_DIR / "tqqq_sp500_prices.csv"
VOLUMES_CSV = LIVE_DIR / "tqqq_sp500_volumes.csv"
...
def get_sp500() -> list[str]:
    ...
    if "Symbol" not in df.columns:
        raise RuntimeError("Wikipedia S&P 500 table does not contain a Symbol column.")
    ...
    print(f"[setup] total symbols: {len(symbols)}")
    return symbols
...
# =========================
def main() -> None:
    print("===== TQQQ / QQQ UNIVERSE SCORING ANALYSIS =====")
    ...
    print("\n===== TOP 30 (LOW-PRICE, HIGH-QUALITY TQQQ/QQQ UNIVERSE CANDIDATES) =====")
